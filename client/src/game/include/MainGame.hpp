...
namespace rtype::client {
    class MainGame {
        ...
        public:
            ...
            void EventGame(rtype::client::TcpClient &, rtype::common::Event &) noexcept;
            void EventFire(rtype::client::TcpClient &, rtype::common::Event &) noexcept;

            bool displayGame(rtype::common::Window &, rtype::client::TcpClient &, rtype::common::Event &, rtype::common::Clock &) noexcept;
